...
* In the Hello World example, transaction is created thru the Transaction class from '@solana/web3.js' library, while in the Break example, CreateTransactionRPC from create-transaction-rpc is used.
* Fewer imports in the Hello World than the Break example.

### Accounts used in Hello World:
* payer
* greetedPubkey
* programId

### Accounts used in Break:
* programId
* feeAccountSecretKey
* programDataAccount
